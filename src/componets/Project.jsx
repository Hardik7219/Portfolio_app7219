...
function Project(props) {
  ...
  return (
    <>
        ...
        bg-gray-950 rounded-lg flex flex-col justify-center items-center'>
            <div onClick={()=>pageLink(props.link)} 
            className='link2 group hover:cursor-pointer border-1 bg-gray-500 rounded-2xl hover:bg-gray-600 border-b-blue-950 flex items-center justify-center'>
                <div  className=' invisible group-hover:visible bg-[url("https://icon.icepanel.io/Technology/png-shadow-512/GitHub.png")]
                bg-cover'></div>
            </div>
            <div className='title rounded-2xl m-1 flex justify-center items-center  border-1 text-3xl
